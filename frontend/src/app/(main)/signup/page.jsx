    ...
    <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
      <div className="lg:w-1/2 xl:w-6/10 p-6 sm:p-1">
        ...
        <div className="mt-12 flex flex-col items-center">
          <div className="w-full flex-1 mt-8">
         ...
         
            {
                          ...
                          <small class="text-red-500">{signupForm.errors.name}</small>
                        }
            <input
        ...
        
        {
                          ...
                          <small class="text-red-500">{signupForm.errors.email}</small>
                        }
              <input
              ...
              />
                  {
                          ...
                          <small class="text-red-500">{signupForm.errors.password}</small>
                        }
              <input
              ...
              />
                  {
                          ...
                          <small class="text-red-500">{signupForm.errors.cpassword}</small>
                        }
               <input
                className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                type="cpassword"
